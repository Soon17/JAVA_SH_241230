...
CREATE TABLE `FILE` (
	...
	`FI_TYPE`	ENUM("T", "S") NOT	NULL,
	`FI_MV_ID`	INT	NOT NULL
);
...
CREATE TABLE `ACTOR` (
	...
	`AT_POSITION`	ENUM("감독", "배우") NOT	NULL,
...
CREATE TABLE `MOVIE` (
	`MV_ID`	INT  PRIMARY KEY AUTO_INCREMENT	NOT NULL,

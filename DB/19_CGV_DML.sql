...
# 영화 참여 등록
INSERT INTO MOVIE_ACTOR(MA_ROLE, MA_MV_ID, MA_AT_NUM) VALUES
("감독", 1, 1),
("미키 반스", 1, 2),
("나샤 배릿지", 1, 3),
("티모", 1, 4),
...
# 영화 장르 등록
INSERT INTO MOVIE_GENRE(MG_MV_ID, MG_GR_NAME) VALUES
(1, "어드벤처"), (1, "SF"), (1, "드라마");

# 제작 국가 등록
INSERT INTO MOVIE_COUNTRY(MC_CT_NAME, MC_MV_ID) VALUES("미국", 1);

# 트레일러와 스틸컷 등록
INSERT INTO FILE(FI_NAME, FI_TYPE, FI_MV_ID) VALUES
("미키17_1.JPG", "S", 1),
("미키17_2.JPG", "S", 1),
("미키17_3.JPG", "S", 1),
("미키17_1.MP4", "T", 1),
...
INSERT INTO THEATER(TT_NAME, TT_ADDR, TT_COUNT, TT_RG_NAME) VALUES
	("CGV강남", "서울 특별시 강남구 강남대로 438(역삼동)", 5, "서울");
    
# 상영관 등록 : CGV 강남 1 ~ 5관
INSERT INTO SCREEN(SC_NAME, SC_SEAT, SC_TT_NUM) VALUES
	("1관", 12, 1), ("2관", 10, 1), ("3관", 15, 1),
    ("4관", 16, 1),("5관", 20, 1);
...
# 3관 09:00, 11:50
# 5관 10:00
INSERT INTO SCHEDULE(SD_DATE, SD_TIME, SD_POS_SEAT, SD_EARLY, SD_MV_ID, SD_SC_NUM) VALUES
...
# abc123 회원이 CGV강남 1관의 3월 11일 16:20에 상영하는 미키 17(기본키 3)의 예약 가능한 좌석 A1, A2를 예매(성인 1, 청소년 1)했을 때 필요한 쿼리
...
INSERT INTO TICKET_LIST(TL_TI_NUM, TL_SE_NUM) VALUE
	(1, 1), (1, 2);
# 스케쥴 테이블(SCHEDULE)에서 좌석 수를 차감하는 쿼리 
UPDATE SCHEDULE
SET SD_POS_SEAT = SD_POS_SEAT - 2
WHERE SD_NUM = 3;

# abc123 회원이 CGV강남 4관의 3월 11일 13:50에 상영하는 미키 17(기본키 1)의 예약 가능한 좌석 A1, A2를 예매(성인 1, 청소년 1)했을 때 필요한 쿼리
INSERT INTO TICKET(TI_ADULT, TI_TEEN, TI_PRICE, TI_ME_NUM, TI_SD_NUM) VALUE
	(1, 1, 27000, 1, 1);
INSERT INTO TICKET_LIST(TL_TI_NUM, TL_SE_NUM) VALUE
	(2, 38), (2, 39);
...
# abc123 회원이 CGV강남 4관의 3월 11일 19:20에 상영하는 미키 17(기본키 2)의 예약 가능한 좌석 A1, A2를 예매(성인 1, 청소년 1)했을 때 필요한 쿼리
INSERT INTO TICKET(TI_ADULT, TI_TEEN, TI_PRICE, TI_ME_NUM, TI_SD_NUM) VALUE
	(1, 1, 27000, 1, 2);
INSERT INTO TICKET_LIST(TL_TI_NUM, TL_SE_NUM) VALUE
	(3, 38), (3, 39);
...
# abc123 회원이 CGV강남 4관의 3월 11일 19:20에 상영하는 미키 17(기본키 2)의 예약 가능한 좌석 A3, A4를 예매(성인 1, 청소년 1)했을 때 필요한 쿼리
INSERT INTO TICKET(TI_ADULT, TI_TEEN, TI_PRICE, TI_ME_NUM, TI_SD_NUM) VALUE
	(1, 1, 27000, 1, 2);
INSERT INTO TICKET_LIST(TL_TI_NUM, TL_SE_NUM) VALUE
	(4, 40), (4, 41);

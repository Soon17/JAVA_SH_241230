...
public class PostController {
	...
	public String listPost(Model model, @RequestParam int num) { //object일땐 RequestParam, json일 땐 RequestBody
		//num을 서비스에게 주면서 게시판 번호에 맞는 게시글 목록 전체를 가져오라고 요청
		List<PostVO> postList = postService.getPostList(num);
